...
<div class="products-sort-order dropdown">
    <button class="btn-unstyle select-title" rel="nofollow" data-toggle="dropdown" aria-label="{l s='Sort by selection' d='Shop.Theme.Global'}" aria-haspopup="true" aria-expanded="false">
        {if $listing.sort_selected}
            {l s='Sort by: %sortSelected%'
                sprintf=[
                    '%sortSelected%' => $listing.sort_selected
                ]
        ...
        {/if}
        <svg xmlns="http://www.w3.org/2000/svg" width="11.199" height="6.916" viewBox="1767.4 684.542 11.199 6.916">
            <path d="m1778.6 685.858-1.316-1.316-4.284 4.275-4.284-4.275-1.316 1.316 5.6 5.6 5.6-5.6Z" fill="#212121" fill-rule="evenodd" data-name="Icon material-navigate-next"/>
        </svg>
    </button>
