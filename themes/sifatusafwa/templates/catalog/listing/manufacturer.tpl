...
{*        <div id="manufacturer-short_description" class="category__view--desc">{$manufacturer.short_description nofilter}</div>*}
        <div id="manufacturer-description" class="category__view--desc">
