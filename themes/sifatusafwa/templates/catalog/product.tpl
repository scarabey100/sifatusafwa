...
{block name='content'}
    ...
    <section id="main">
        ...
        <div class="product-container js-product-container product__view">
                ...
                <div class="product-information">
                    {block name='product_description_short'}
                        <div class="product-description">
                            <div class="product-description__inner">{$product.description_short nofilter}</div>
                        </div>
                    {/block}
...
{*                                {/block}*}
        ...
        {include file='catalog/_partials/editions.tpl'}
        {block name='product_accessories'}
            {if $accessories}
                <section class="featured-products featured-products__slider">
                    <div class="container">
                        <h2 class="featured-products__title">{l s='You might also like' d='Shop.Theme.Catalog'}</h2>
                        <div class="products">
