...
{block name='cart_summary_product_line'}
    ...
    <div class="media-body">
        ...
        <div class="product-ref">{l s='Ref' d='Shop.Theme.Global'} : {$product.reference}</div>
        <div class="product-quantity">{l s='Quantity' d='Shop.Theme.Global'} : {$product.quantity}</div>
