                                        ...
                                        <%  function getProducts() {
                                            $.ajax({
                                                ...
                                                success: function(response) {
                                                    $(".kuQuickResultsListContainerAfterSearch").empty();
                                                    $(".kuQuickResultsListContainerAfterSearch").append(response.products);
                                                }
                                            });
                                        } %>
                                        <%  getProducts()   %>
                                        <div class="kuQuickResultsListContainerAfterSearch">
                                        </div>
                                </div>
                            </div>
                        </div>
