            ...
            <div class="ets_geo_popup_content">
                ...
                <div class="ets_geo_popup_content_confirmation">
                    ...
                    <div class="ets_btn_signin">
                        <a class="link_to_signin btn btn-primary" href="{if isset($url_cart_page) && $url_cart_page}{$url_cart_page|escape:'html':'UTF-8'}{else}#{/if}">
                    ...
                    <div class="ets_geo_wrap_zipcode">
                        <span class="ets_geo_btn_submit_apply btn btn-primary">{l s='Apply' mod='ets_geolocation'}</span>
                    </div>
                </div>
            </div>
        </div>
