...
{block name='page_content'}
    <div id="choicegiftcard" data-link-controller="{$linkcgc|escape:'htmlall':'UTF-8'}">
        ...
        <div class="category__view">{$front_content nofilter}</div>

        {if !isset($gc_templates) || count($gc_templates) == 0}
            <p class="warning">{l s='No model available' mod='giftcard'}</p>
        {elseif !isset($cards) || $cards|@count == 0}
            <p class="warning">{l s='No card available' mod='giftcard'}</p>
        {else}
            <form class="form" id="formgiftcard" action="{$linkcgc|escape:'quotes':'UTF-8'}" method="POST" target="_blank">

                {*** STEP 1 RECEPTION MODE ***}
                <section id="gc-step-receptmode" class="step step-current">
                    <h2 class="step-title">
                    ...
                    <div class="step-content">
                            ...
                            {if $virtual_cards_available}
                                ...
                                <label for="receptmode_printathome">
                                    <svg height="20" viewBox="0 0 512 512" width="20" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <path d="M296,353h-80c-8.3,0-15,6.7-15,15s6.7,15,15,15h80c8.3,0,15-6.7,15-15S304.3,353,296,353z" />
                                        <path d="M296,417h-80c-8.3,0-15,6.7-15,15s6.7,15,15,15h80c8.3,0,15-6.7,15-15S304.3,417,296,417z" />
                                        <path d="M128,193H80c-8.3,0-15,6.7-15,15c0,8.3,6.7,15,15,15h48c8.3,0,15-6.7,15-15C143,199.7,136.3,193,128,193z" />
                                    </svg>
                        ...
                        {if $virtual_cards_available}
                            <div id="recepmode-mail-additional-information">
                                <p>{l s='Send by e-mail' mod='giftcard'}</p>
                                <div class="form-group">
                                    <input name="mailto" type="text" class="form-control email" placeholder="{l s='To : Email' mod='giftcard'}" />
                                </div>
                                <p>{l s='The gift card will be sent by email to the recipient as soon as your payment is confirmed. You can also choose to send at a later date by selecting that date below.' mod='giftcard'}</p>
                        ...
                        <div class="step-action">
                            <button class="btn btn-primary" type="button" data-rel-gcstep="gc-step-template">{l s='Continue' mod='giftcard'}</button>
                        </div>
                    </div>
                </section>
                ...
                <section id="gc-step-template" class="step">
                    <h2 class="step-title">
                        <i class="material-icons done">check</i>
                    ...
                    <div class="step-content">
                        ...
                        <div class="step-action">
                            <button class="btn btn-primary" type="button" data-rel-gcstep="gc-step-information">{l s='Continue' mod='giftcard'}</button>
                        </div>
                    </div>
                </section>
                ...
                <section id="gc-step-information" class="step">
                    <h2 class="step-title">
                        <i class="material-icons done">check</i>
