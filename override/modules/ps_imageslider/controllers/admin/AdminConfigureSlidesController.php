 ...
 */
class AdminConfigureSlidesControllerOverride extends AdminConfigureSlidesController
{
    public function initContent()
    {
        ...
        Tools::redirectAdmin('index.php?controller=AdminModules&configure=ps_imageslider&token='.$token);
    }
