 ...
 */
class Ps_HomeSlideOverride extends ObjectModel
{
    public $title;
    public $description;
    public $url;
    ...
    public static $definition = [
        ...
        'fields' => [
            ...
            'vimeo_video' => ['type' => self::TYPE_STRING,'size' => 255],
            'type_video' => ['type' => self::TYPE_STRING,'size' => 255],
            'btn_1_title' => ['type' => self::TYPE_STRING,'lang' => true,'size' => 255],
            'btn_1_url' => ['type' => self::TYPE_STRING,'lang' => true,'size' => 255],
            'btn_2_title' => ['type' => self::TYPE_STRING,'lang' => true,'size' => 255],
            'btn_2_url' => ['type' => self::TYPE_STRING,'lang' => true,'size' => 255],
            'content_position' => ['type' => self::TYPE_STRING, 'validate' => 'isString', 'size' => 255],
