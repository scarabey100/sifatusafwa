 ...
 */
class Ets_geolocationProcessModuleFrontControllerOverride extends Ets_geolocationProcessModuleFrontController
{
        public function initContent()
    {
        ...
        if (Tools::isSubmit('choose_country')) {
            ...
            $content_pop_choose = $this->context->smarty->fetch(_PS_THEME_DIR_ . 'modules/ets_geolocation/views/templates/front/popup_choose.tpl');
            exit(json_encode([
