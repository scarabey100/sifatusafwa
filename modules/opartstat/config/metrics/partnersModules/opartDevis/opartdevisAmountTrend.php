...
function getOpartdevisAmountTrend($vars)
{
    return OpartStatTools::getMetricResult('OpartdevisAmountTrend', $vars);
}

function getOpartdevisAmountTrendValues($dateFrom, $dateTo, $filtersArray, $vars)
{
