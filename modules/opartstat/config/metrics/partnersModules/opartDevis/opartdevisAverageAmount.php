...
function getOpartdevisAverageAmount($vars)
{
    return OpartStatTools::getMetricResult('OpartdevisAverageAmount',$vars);
}

function getOpartdevisAverageAmountValues($dateFrom, $dateTo, $filtersArray, $vars)
{
