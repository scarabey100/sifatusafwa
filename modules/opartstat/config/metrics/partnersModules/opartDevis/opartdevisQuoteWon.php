...
function getOpartdevisQuoteWon($vars)
{
    return OpartStatTools::getMetricResult('OpartdevisQuoteWon',$vars);
}

function getOpartdevisQuoteWonValues($dateFrom, $dateTo, $filtersArray, $vars)
{
