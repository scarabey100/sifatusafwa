...
function getGoogleAdsBestGroupsPerConversions($vars, $humanResult = true)
{
    return OpartStatTools::getBestMetricResult('googleAdsBestGroupsPerConversions', $vars);
}

function getGoogleAdsBestGroupsPerConversionsValues($dateFrom, $dateTo, $filtersArray, $start, $limit, $vars)
{
    ...
    /* $response = OpartStatTools::getMetricsResultFromSaas("metrics/googleAds/bestGroupsPerConversions.php", $useCache, $datas);
