...
function getBestRevenuesLandingPages($vars)
{
    return OpartStatTools::getBestMetricResult('bestRevenuesLandingPages',$vars);
}

function getBestRevenuesLandingPagesValues($dateFrom, $dateTo, $filtersArray, $start, $limit,$vars) {
