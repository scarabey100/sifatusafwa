...
function getGoogleAdsNumberOfNewCustomers($vars, $humanResult = true)
{
    return OpartStatTools::getMetricResult('GoogleAdsNumberOfNewCustomers', $vars);
}

function getGoogleAdsNumberOfNewCustomersValues($dateFrom, $dateTo, $filtersArray, $vars)
{
    $result['value'] = 0;
    $result['conf'] = [
        'total' => ''
