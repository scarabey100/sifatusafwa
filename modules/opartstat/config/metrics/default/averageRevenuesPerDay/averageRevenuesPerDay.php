...
function getAverageRevenuesPerDay($vars)
{
    return OpartStatTools::getMetricResult('AverageRevenuesPerDay',$vars);
}

function getAverageRevenuesPerDayValues($dateFrom, $dateTo, $filtersArray, $vars) {
