...
function getAverageProfitsPerOrder($vars,$humanResult=true)
{   
    return OpartStatTools::getMetricResult('AverageProfitsPerOrder',$vars);
}

function getAverageProfitsPerOrderValues($dateFrom,$dateTo,$filtersArray,$vars) {
    ...
    $sql =  "SELECT SQL_NO_CACHE  
                SUM(orderMargin) / COUNT(DISTINCT commande)
            FROM 
                (
                    SELECT   
