...
function getGoogleAdsCustomerAcquisitionCost($vars, $humanResult = true)
{
    return OpartStatTools::getMetricResult('GoogleAdsCustomerAcquisitionCost', $vars);
}

function getGoogleAdsCustomerAcquisitionCostValues($dateFrom, $dateTo, $filtersArray, $vars)
{
    $result['value'] = 0;
    $result['conf'] = [
        'total' => 'price'
