...
function getGoogleAdsBestAdsPerConversions($vars, $humanResult = true)
{
    return OpartStatTools::getBestMetricResult('googleAdsBestAdsPerConversions', $vars);
}

function getGoogleAdsBestAdsPerConversionsValues($dateFrom, $dateTo, $filtersArray, $start, $limit, $vars)
{
    ...
    /*
    $response = OpartStatTools::getMetricsResultFromSaas("metrics/googleAds/bestAdsPerConversions.php", $useCache, $datas);

    $ads = $response['datas']; */

    $ads = OpartStatTools::getOriginConversion('firstClick', $datas);
