...
function getNumberOfRefunds($vars,$humanResult=true)
{   
    return OpartStatTools::getMetricResult('NumberOfRefunds',$vars,'',false);
}

function getNumberOfRefundsValues($dateFrom,$dateTo,$filtersArray,$vars) {
