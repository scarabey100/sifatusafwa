...
function getBestRevenuesCampaigns($vars)
{
    return OpartStatTools::getBestMetricResult('bestRevenuesCampaigns', $vars);
}

function getBestRevenuesCampaignsValues($dateFrom, $dateTo, $filtersArray, $start, $limit, $vars)
{
