...
function getGoogleAdsClicksTrend($vars, $humanResult = true)
{
    return OpartStatTools::getMetricResult('googleAdsClicksTrend', $vars);
}

function getGoogleAdsClicksTrendValues($dateFrom, $dateTo, $filtersArray, $vars)
{
    ...
    $response = OpartStatTools::getMetricsResultFromSaas("metrics/googleAds/clicksTrend.php",$useCache,$datas);
    $cpms = $response['datas']; */
