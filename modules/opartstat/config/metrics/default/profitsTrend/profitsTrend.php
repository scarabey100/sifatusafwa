...
function getProfitsTrend($vars, $humanResult = true)
{
    return OpartStatTools::getMetricResult('ProfitsTrend',$vars,'price');
}

function getProfitsTrendValues($dateFrom,$dateTo, $filtersArray) {
