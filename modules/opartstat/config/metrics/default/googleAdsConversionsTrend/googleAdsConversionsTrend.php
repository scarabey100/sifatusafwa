...
function getGoogleAdsConversionsTrend($vars, $humanResult = true)
{
    return OpartStatTools::getMetricResult('googleAdsConversionsTrend', $vars, 'price', false);
}

function getGoogleAdsConversionsTrendValues($dateFrom, $dateTo, $filtersArray, $vars)
{
    $result['value'] = 0;
    $result['conf'] = [
        'total' => 'price'
    ...
    /* $response = OpartStatTools::getMetricsResultFromSaas("metrics/googleAds/conversionsTrend.php",$useCache,$datas);
