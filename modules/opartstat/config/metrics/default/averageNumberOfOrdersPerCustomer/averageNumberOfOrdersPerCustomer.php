...
function getAverageNumberOfOrdersPerCustomer($vars,$humanResult=true)
{   
    return OpartStatTools::getMetricResult('AverageNumberOfOrdersPerCustomer',$vars);
}

function getAverageNumberOfOrdersPerCustomerValues($dateFrom,$dateTo,$filtersArray,$vars) {
