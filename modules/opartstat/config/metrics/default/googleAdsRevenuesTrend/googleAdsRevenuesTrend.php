...
function getGoogleAdsRevenuesTrend($vars, $humanResult = true)
{
    return OpartStatTools::getMetricResult('GoogleAdsRevenuesTrend', $vars);
}

function getGoogleAdsRevenuesTrendValues($dateFrom, $dateTo, $filtersArray, $vars)
{
    $result['value'] = [
        'globalValue' => 0
    ];
    ...
    /* $response = OpartStatTools::getMetricsResultFromSaas("metrics/googleAds/revenuesTrend.php", $useCache, $datas);

    $revenues = $response['datas']; */
    ...
    $r = OpartStatTools::populatePeriodArray($dateFrom, $dateTo, $revenues, 'createdAt', 'total');
