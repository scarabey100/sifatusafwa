...
function getGoogleAdsCostsTrend($vars,$humanResult=true)
{   
    return OpartStatTools::getMetricResult('googleAdsCostsTrend',$vars,'price',false);
}

function getGoogleAdsCostsTrendValues($dateFrom,$dateTo,$filtersArray,$vars) {
    ...
    $response = OpartStatTools::getMetricsResultFromSaas("metrics/googleAds/costsTrend.php",$useCache,$datas);
    $cpms = $response['datas']; */
