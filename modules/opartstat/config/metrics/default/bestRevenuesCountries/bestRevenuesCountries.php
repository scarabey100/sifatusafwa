...
function getBestRevenuesCountries($vars)
{
    return OpartStatTools::getBestMetricResult('bestRevenuesCountries',$vars);
}

function getBestRevenuesCountriesValues($dateFrom, $dateTo, $filtersArray, $start, $limit,$vars) {
