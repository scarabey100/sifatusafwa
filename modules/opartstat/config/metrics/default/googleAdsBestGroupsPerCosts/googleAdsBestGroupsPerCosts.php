...
function getGoogleAdsBestGroupsPerCosts($vars,$humanResult=true)
{   
    return OpartStatTools::getBestMetricResult('googleAdsBestGroupsPerCosts', $vars, 'price', false);
}

function getGoogleAdsBestGroupsPerCostsValues($dateFrom,$dateTo,$filtersArray,$start,$limit,$vars) {
    ...
    $response = OpartStatTools::getMetricsResultFromSaas("metrics/googleAds/bestGroupsPerCosts.php",$useCache,$datas);
