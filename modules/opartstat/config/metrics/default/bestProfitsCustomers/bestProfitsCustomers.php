...
function getBestProfitsCustomers($vars)
{
    return OpartStatTools::getBestMetricResult('bestProfitsCustomers',$vars);
}

function getBestProfitsCustomersValues($dateFrom, $dateTo, $filtersArray, $start, $limit,$vars) {
    ...
    $sqlJoins = OpartStatTools::getJoins($filtersArray,['customer','order_detail'],[],true);
    ...
    foreach ($orderList as $o) {
        ...
        if (!empty($mergedCustomerList[$o['id_customer']]['total'])) {
            $mergedCustomerList[$o['id_customer']]['total'] = $total+$mergedCustomerList[$o['id_customer']]['total'];
        }
        else {
