...
function getGoogleAdsBestAdsPerRevenues($vars, $humanResult = true)
{
    return OpartStatTools::getBestMetricResult('googleAdsBestAdsPerRevenues', $vars, 'price', false);
}

function getGoogleAdsBestAdsPerRevenuesValues($dateFrom, $dateTo, $filtersArray, $start, $limit, $vars)
{
    ...
    /* $response = OpartStatTools::getMetricsResultFromSaas("metrics/googleAds/bestAdsPerRevenues.php", $useCache, $datas);
