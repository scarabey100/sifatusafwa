...
function getBestProfitsCampaigns($vars)
{
    return OpartStatTools::getBestMetricResult('bestProfitsCampaigns', $vars);
}

function getBestProfitsCampaignsValues($dateFrom, $dateTo, $filtersArray, $start, $limit, $vars)
{
