...
function getbestProfitsProducts($vars)
{
    return OpartStatTools::getBestMetricResult('bestProfitsProducts',$vars);
}

function getbestProfitsProductsValues($dateFrom, $dateTo, $filtersArray, $start, $limit,$vars) {
