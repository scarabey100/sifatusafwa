...
function getbestProfitsVariationsAndFeatures($vars)
{
    return OpartStatTools::getBestMetricResult('bestProfitsVariationsAndFeatures',$vars);
}

function getbestProfitsVariationsAndFeaturesValues($dateFrom, $dateTo, $filtersArray, $start, $limit,$vars) {
