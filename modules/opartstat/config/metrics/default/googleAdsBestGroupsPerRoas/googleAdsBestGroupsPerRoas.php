...
function getGoogleAdsBestGroupsPerRoas($vars, $humanResult = true)
{
    return OpartStatTools::getBestMetricResult('googleAdsBestGroupsPerRoas', $vars, 'price', false);
}

function getGoogleAdsBestGroupsPerRoasValues($dateFrom, $dateTo, $filtersArray, $start, $limit, $vars)
{
    ...
    /* $response = OpartStatTools::getMetricsResultFromSaas("metrics/googleAds/bestGroupsPerRoas.php", $useCache, $datas);
