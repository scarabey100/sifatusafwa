...
function getGoogleAdsBestCampaignsPerCosts($vars,$humanResult=true)
{   
    return OpartStatTools::getBestMetricResult('googleAdsBestCampaignsPerCosts', $vars, 'price', false);
}

function getGoogleAdsBestCampaignsPerCostsValues($dateFrom,$dateTo,$filtersArray,$start,$limit,$vars) {
    ...
    $response = OpartStatTools::getMetricsResultFromSaas("metrics/googleAds/bestCampaignsPerCosts.php",$useCache,$datas);
