...
function getGlobalRevenues($vars,$humanResult=true)
{   
    return OpartStatTools::getMetricResult('GlobalRevenues',$vars);
}

function getGlobalRevenuesValues($dateFrom,$dateTo,$filtersArray,$vars) {
