...
function getBestRevenuesSources($vars)
{
    return OpartStatTools::getBestMetricResult('bestRevenuesSources', $vars);
}

function getBestRevenuesSourcesValues($dateFrom, $dateTo, $filtersArray, $start, $limit, $vars)
{
    ...
    $sources = OpartStatTools::getOriginConversion('firstClick',$datas);
