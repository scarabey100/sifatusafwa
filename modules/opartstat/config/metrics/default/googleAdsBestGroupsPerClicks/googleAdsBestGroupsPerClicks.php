...
function getGoogleAdsBestGroupsPerClicks($vars,$humanResult=true)
{   
    return OpartStatTools::getBestMetricResult('googleAdsBestGroupsPerClicks', $vars);
}

function getGoogleAdsBestGroupsPerClicksValues($dateFrom,$dateTo,$filtersArray,$start,$limit,$vars) {
    $result['conf']['total'] = '';
    $result['value'] = [];
    ...
    $response = OpartStatTools::getMetricsResultFromSaas("metrics/googleAds/bestGroupsPerClicks.php",$useCache,$datas);
