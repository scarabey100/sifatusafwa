...
function getGoogleAdsBestAdsPerClicks($vars,$humanResult=true)
{   
    return OpartStatTools::getBestMetricResult('googleAdsBestAdsPerClicks', $vars);
}

function getGoogleAdsBestAdsPerClicksValues($dateFrom,$dateTo,$filtersArray,$start,$limit,$vars) {
    $result['conf']['total'] = '';
    $result['value'] = [];
    ...
    $response = OpartStatTools::getMetricsResultFromSaas("metrics/googleAds/bestAdsPerClicks.php",$useCache,$datas);
