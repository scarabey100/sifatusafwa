...
function getBestRevenuesCategories($vars)
{
    return OpartStatTools::getBestMetricResult('bestRevenuesCategories',$vars);
}

function getbestRevenuesCategoriesValues($dateFrom, $dateTo, $filtersArray, $start, $limit,$vars)
{
