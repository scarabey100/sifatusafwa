...
function getBestProfitsBrands($vars)
{
    return OpartStatTools::getBestMetricResult('bestProfitsBrands', $vars);
}

function getBestProfitsBrandsValues($dateFrom, $dateTo, $filtersArray, $start, $limit,$vars) {
