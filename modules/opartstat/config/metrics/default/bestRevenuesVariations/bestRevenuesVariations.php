...
function getbestRevenuesVariations($vars)
{
    return OpartStatTools::getBestMetricResult('bestRevenuesVariations',$vars);
}

function getbestRevenuesVariationsValues($dateFrom, $dateTo, $filtersArray, $start, $limit, $vars) {
