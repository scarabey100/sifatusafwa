...
function getBestRevenuesCustomers($vars)
{
    return OpartStatTools::getBestMetricResult('bestRevenuesCustomers',$vars);
}

function getBestRevenuesCustomersValues($dateFrom, $dateTo, $filtersArray, $start, $limit,$vars) {
