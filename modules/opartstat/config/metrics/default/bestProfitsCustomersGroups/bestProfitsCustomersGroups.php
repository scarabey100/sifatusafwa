...
function getBestProfitsCustomersGroups($vars)
{
    return OpartStatTools::getBestMetricResult('bestProfitsCustomersGroups',$vars);
}

function getBestProfitsCustomersGroupsValues($dateFrom, $dateTo, $filtersArray, $start, $limit,$vars) {
