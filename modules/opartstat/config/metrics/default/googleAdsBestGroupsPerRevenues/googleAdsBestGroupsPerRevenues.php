...
function getGoogleAdsBestGroupsPerRevenues($vars, $humanResult = true)
{
    return OpartStatTools::getBestMetricResult('googleAdsBestGroupsPerRevenues', $vars, 'price', false);
}

function getGoogleAdsBestGroupsPerRevenuesValues($dateFrom, $dateTo, $filtersArray, $start, $limit, $vars)
{
...
";
    ...
    /* $response = OpartStatTools::getMetricsResultFromSaas("metrics/googleAds/bestGroupsPerRevenues.php", $useCache, $datas);

    $groups = $response['datas']; */

    $groups = OpartStatTools::getOriginConversion('firstClick',$datas);
