...
function getGoogleAdsRoasTrend($vars, $humanResult = true)
{
    return OpartStatTools::getMetricResult('GoogleAdsRoasTrend', $vars);
}

function getGoogleAdsRoasTrendValues($dateFrom, $dateTo, $filtersArray, $vars)
{
    $result['value'] = 0;
    $result['conf'] = [
        'total' => 'price'
   ...
   if ($dateFrom == 0 || $dateTo == 0)
    ...
    /* $response = OpartStatTools::getMetricsResultFromSaas("metrics/googleAds/roasTrend.php", $useCache, $datas);

    $roass = $response['datas']; */
    ...
    $sql = "SELECT SQL_NO_CACHE 
                SUM(costMicros/1000000) as total,
    ...
    $r = OpartStatTools::populatePeriodArray($dateFrom, $dateTo, $roass, 'date', 'total');
