...
function getGoogleAdsBestAdsPerCostPerConversion($vars, $humanResult = true)
{
    return OpartStatTools::getBestMetricResult('googleAdsBestAdsPerCostPerConversion', $vars);
}

function getGoogleAdsBestAdsPerCostPerConversionValues($dateFrom, $dateTo, $filtersArray, $start, $limit, $vars)
{
    ...
    /* $response = OpartStatTools::getMetricsResultFromSaas("metrics/googleAds/bestAdsPerCostPerConversion.php", $useCache, $datas);
