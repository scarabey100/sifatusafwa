...
function getGoogleAdsBestCampaignsPerRevenues($vars, $humanResult = true)
{
    return OpartStatTools::getBestMetricResult('googleAdsBestCampaignsPerRevenues', $vars, 'price', false);
}

function getGoogleAdsBestCampaignsPerRevenuesValues($dateFrom, $dateTo, $filtersArray, $start, $limit, $vars)
{
    ...
    $campaigns = OpartStattools::getOriginConversion('firstClick',$datas);

    /* $response = OpartStatTools::getMetricsResultFromSaas("metrics/googleAds/bestCampaignsPerRevenues.php", $useCache, $datas);
