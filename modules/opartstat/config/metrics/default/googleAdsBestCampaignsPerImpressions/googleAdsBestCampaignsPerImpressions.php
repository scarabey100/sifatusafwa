...
function getGoogleAdsBestCampaignsPerImpressions($vars,$humanResult=true)
{   
    return OpartStatTools::getBestMetricResult('googleAdsBestCampaignsPerImpressions', $vars);
}

function getGoogleAdsBestCampaignsPerImpressionsValues($dateFrom,$dateTo,$filtersArray,$start,$limit,$vars) {
    $result['conf']['total'] = '';
    $result['value'] = [];
    ...
    $response = OpartStatTools::getMetricsResultFromSaas("metrics/googleAds/bestCampaignsPerImpressions.php",$useCache,$datas);
