...
function getGoogleAdsBestCampaignsPerConversions($vars,$humanResult=true)
{   
    return OpartStatTools::getBestMetricResult('googleAdsBestCampaignsPerConversions', $vars);
}

function getGoogleAdsBestCampaignsPerConversionsValues($dateFrom,$dateTo,$filtersArray,$start,$limit,$vars) {
    ...
    /* $response = OpartStatTools::getMetricsResultFromSaas("metrics/googleAds/bestCampaignsPerConversions.php",$useCache,$datas);
