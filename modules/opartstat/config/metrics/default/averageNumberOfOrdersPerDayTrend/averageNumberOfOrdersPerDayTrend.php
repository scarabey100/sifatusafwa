...
function getAverageNumberOfOrdersPerDayTrend($vars, $humanResult = true)
{
    return OpartStatTools::getMetricResult('AverageNumberOfOrdersPerDayTrend', $vars, 'float2');
}

function getAverageNumberOfOrdersPerDayTrendValues($dateFrom, $dateTo, $filtersArray, $vars) {
