...
function getBestRevenuesMediums($vars)
{
    return OpartStatTools::getBestMetricResult('bestRevenuesMediums', $vars);
}

function getBestRevenuesMediumsValues($dateFrom, $dateTo, $filtersArray, $start, $limit, $vars)
{
    ...
    $mediums = OpartStatTools::getOriginConversion('firstClick',$datas);

    $result['value'] = $mediums;
