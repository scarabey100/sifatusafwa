...
function getGoogleAdsBestAdsPerRoas($vars, $humanResult = true)
{
    return OpartStatTools::getBestMetricResult('googleAdsBestAdsPerRoas', $vars, 'price', false);
}

function getGoogleAdsBestAdsPerRoasValues($dateFrom, $dateTo, $filtersArray, $start, $limit, $vars)
{
    ...
    $datas = [
        ...
        'originType' => "googleAdsAds",
        'totalType' => "orderTotal",
        'useCache' => $useCache
    ];

    /* $response = OpartStatTools::getMetricsResultFromSaas("metrics/googleAds/bestAdsPerRoas.php", $useCache, $datas);
