...
function getcustomersWithNoOrder($vars)
{
    return OpartStatTools::getBestMetricResult('customersWithNoOrder',$vars);
}

function getcustomersWithNoOrderValues($dateFrom, $dateTo, $filtersArray, $start, $limit,$vars) {
    $result['conf']['total'] = '';
    $result['value'] = [];
