...
function getBestProfitsMediums($vars)
{
    return OpartStatTools::getBestMetricResult('bestProfitsMediums', $vars);
}

function getBestProfitsMediumsValues($dateFrom, $dateTo, $filtersArray, $start, $limit, $vars)
{
