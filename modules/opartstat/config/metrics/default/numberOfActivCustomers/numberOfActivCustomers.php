...
function getNumberOfActivCustomers($vars,$humanResult=true)
{   
    return OpartStatTools::getMetricResult('NumberOfActivCustomers',$vars);
}

function getNumberOfActivCustomersValues($dateFrom,$dateTo,$filtersArray,$vars) {
