...
function getGoogleAdsConversions($vars, $humanResult = true)
{
    return OpartStatTools::getMetricResult('GoogleAdsConversions', $vars);
}

function getGoogleAdsConversionsValues($dateFrom, $dateTo, $filtersArray, $vars)
{
    $result['value'] = 0;
    $result['conf'] = [
        'total' => 'float2'
    ...
    /* $response = OpartStatTools::getMetricsResultFromSaas("metrics/googleAds/conversions.php", $useCache, $datas);
