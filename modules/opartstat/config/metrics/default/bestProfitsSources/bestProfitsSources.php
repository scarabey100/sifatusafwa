...
function getBestProfitsSources($vars)
{
    return OpartStatTools::getBestMetricResult('bestProfitsSources',$vars);
}

function getBestProfitsSourcesValues($dateFrom, $dateTo, $filtersArray, $start, $limit,$vars) {
