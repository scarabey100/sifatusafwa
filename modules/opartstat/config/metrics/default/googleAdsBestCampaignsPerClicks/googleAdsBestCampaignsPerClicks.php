...
function getGoogleAdsBestCampaignsPerClicks($vars,$humanResult=true)
{   
    return OpartStatTools::getBestMetricResult('googleAdsBestCampaignsPerClicks', $vars);
}

function getGoogleAdsBestCampaignsPerClicksValues($dateFrom,$dateTo,$filtersArray,$start,$limit,$vars) {
    $result['conf']['total'] = '';
    $result['value'] = [];
    ...
    $response = OpartStatTools::getMetricsResultFromSaas("metrics/googleAds/bestCampaignsPerClicks.php",$useCache,$datas);
