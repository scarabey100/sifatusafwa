...
function getbestSellsVariations($vars)
{
    return OpartStatTools::getBestMetricResult('bestSellsVariations',$vars);
}

function getbestSellsVariationsValues($dateFrom, $dateTo, $filtersArray, $start, $limit,$vars) {
    $result['conf']['total'] = '';
    $result['value'] = [];
