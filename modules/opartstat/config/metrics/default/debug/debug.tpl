 ...
 *}
{* Global revenues *}
<div class="panel panel-default osStatPanel osDebugPanel" style="grid-column-end:span {$cols|escape:'html':'UTF-8'}; grid-row-end:span {$rows|escape:'html':'UTF-8'};">
    ...
    <div class="panel-body">
        ...
        <div id="{$metricName|escape:'html':'UTF-8'}Container"> -- </div>
    </div>
</div>