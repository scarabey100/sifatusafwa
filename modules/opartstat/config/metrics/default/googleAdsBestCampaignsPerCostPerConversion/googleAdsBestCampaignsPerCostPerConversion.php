...
function getGoogleAdsBestCampaignsPerCostPerConversion($vars, $humanResult = true)
{
    return OpartStatTools::getBestMetricResult('googleAdsBestCampaignsPerCostPerConversion', $vars);
}

function getGoogleAdsBestCampaignsPerCostPerConversionValues($dateFrom, $dateTo, $filtersArray, $start, $limit, $vars)
{
