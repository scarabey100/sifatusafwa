...
class KlevuCrossSell1 extends Module
{
    public function __construct()
    {
        $this->name = 'klevucrosssell1';
        ...
        $this->displayName = $this->l('Klevu Cross Sell Products 1');
    ...
    public function install()
    {
        ...
        return parent::install() &&
            ...
            Configuration::updateValue('KLEVU_CROSSSELL1_TEXT', '');
    }
    ...
    public function uninstall()
    {
        ...
        return parent::uninstall() &&
            Configuration::deleteByName('KLEVU_CROSSSELL1_TEXT');
    }
      /**
     * Create Tab 
     */
    ...
    */
    ...
    public function getTabs()
    {
        return [
            [
                'className' => 'AdminKlevuCrossSell1',
                'parent' => 'CONFIGURE',
    ...
    public function getContent()
    {
        if (Tools::isSubmit('submitAddconfiguration')) { 
            ...
            foreach (Language::getLanguages(false) as $lang) {
                $title[$lang['id_lang']] = Tools::getValue('KLEVU_CROSSSELL1_TEXT_' . $lang['id_lang']);
            }
            foreach ($title as $id_lang => $value) { 
                Configuration::updateValue('KLEVU_CROSSSELL1_TEXT_'.$id_lang, $value, true); // Save multilingual title
            }
    ...
    protected function renderForm()
    {
        ...
        foreach (Language::getLanguages(false) as $lang) {
            $title = Configuration::get('KLEVU_CROSSSELL1_TEXT_'.$lang['id_lang']);
            $helper->fields_value['KLEVU_CROSSSELL1_TEXT'][$lang['id_lang']] = $title ?? '';
        }
    ...
    public function hookDisplayFooterProduct($params)
    {
        ...
        $text = Configuration::get('KLEVU_CROSSSELL1_TEXT_'.$id_lang);
        if ($text) {
            return '<div class="klevu-crosssell1">'.$text.'</div>';
        }
        return '';
    }
}
