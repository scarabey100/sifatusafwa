    ...
    <div id="dev_page-index" class="dev_page">
      ...
      {if $dev_part eq 'onboarding' || $dev_part eq 'existing'}
        <article class="onboarding reg-refresh">
          <div style="text-align:center;">
            <h1>{l s='Bring your customers closer' mod='zendesk'}</h1>
            <h2>{l s='Zendesk makes software for better customer support.' mod='zendesk'}</h3>
            <h3>
              {l s='Over 70,000 companies worldwide use Zendesk to increase' mod='zendesk'}<br />
              {l s='satisfaction and improve relationships with their customers.' mod='zendesk'}
            </h2>
          </div>
          <div class="hero">
            <!--
            ...
            <div id="dev_part-hero-buttons" class="dev_part {if $dev_part eq 'existing'}hide{/if}">
              <p id="hero-buttons">
                <a class="zendesk-btn zendesk-btn-gray" href="{$setting_url|escape:'htmlall':'UTF-8'}&amp;part=existing">{l s='I have an account' mod='zendesk'}</a>
                <span>or</span>
            ...
            <div id="dev_part-existing" class="dev_part {if $dev_part != 'existing'}hide{/if}">
              ...
              <div class="step-wrap">
                <div class="step">
                  <form id="submitSubDomainExist" method="post" class="reg" action="{$setting_url|escape:'htmlall':'UTF-8'}&amp;page=settings">
      ...
      {if $dev_part eq 'trial'}
        <article class="trial reg-refresh">
          <a href="{$setting_url|escape:'htmlall':'UTF-8'}&amp;part=onboarding" class="back">{l s='Back' mod='zendesk'}</a>
            ...
            <div class="step">
              <form method="post" class="reg" id="trial-form">
                ...
                <ul>
                  ...
                  <li class="full create">
                    <div class="loading-indicator"></div>
                    <a id="btnCreateTrial" class="zendesk-btn-next zendesk-btn zendesk-btn-orange" href="{$url_post|escape:'htmlall':'UTF-8'}&amp;configure=zendesk&amp;page=settings">{l s='Next' mod='zendesk'}</a>
                  </li>
                </ul>
              </form>
            </div>
