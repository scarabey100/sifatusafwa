...
class AdminZendeskController extends ModuleAdminController
{
    ...
    public function renderView()
    {
        ...
        if (Tools::isSubmit('submitUpdateType')) {
            $this->module->api->updateTicket((int) $id_ticket, ['type' => Tools::getValue('type', '')]);
        } elseif (Tools::isSubmit('submitUpdatePriority')) {
            $this->module->api->updateTicket((int) $id_ticket, ['priority' => Tools::getValue('priority', '')]);
        } elseif (Tools::isSubmit('submitUpdateStatus')) {
            $this->module->api->updateTicket((int) $id_ticket, ['status' => Tools::getValue('status', '')]);
