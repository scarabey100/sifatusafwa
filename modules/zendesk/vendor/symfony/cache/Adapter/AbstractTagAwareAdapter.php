...
abstract class AbstractTagAwareAdapter implements TagAwareAdapterInterface, TagAwareCacheInterface, LoggerAwareInterface, ResettableInterface
{
     ...
     */
    abstract protected function doSave($values, ?int $lifetime, array $addTagData = [], array $removeTagData = []): array;
     ...
     */
    abstract protected function doDelete($ids, array $tagData = []): bool;
     ...
     */
    abstract protected function doInvalidate($tagIds): bool;
     ...
     */
    private function extractTagData($values, ?array &$addTagData, ?array &$removeTagData): array
    {
