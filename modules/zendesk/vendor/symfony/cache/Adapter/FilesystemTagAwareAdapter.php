...
class FilesystemTagAwareAdapter extends AbstractTagAwareAdapter implements PruneableInterface
{
    ...
    public function __construct($namespace = '', int $defaultLifetime = 0, string $directory = null, MarshallerInterface $marshaller = null)
    {
     ...
     * {@inheritdoc}
     */
    protected function doSave($values, ?int $lifetime, array $addTagData = [], array $removeTagData = []): array
    {
     ...
     * {@inheritdoc}
     */
    protected function doDelete($ids, array $tagData = []): bool
    {
