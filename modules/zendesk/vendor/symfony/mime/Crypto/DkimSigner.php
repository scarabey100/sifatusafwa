...
final class DkimSigner
{
     ...
     */
    public function __construct($pk, string $domainName, string $selector, array $defaultOptions = [], string $passphrase = '')
    {
    ...
    private function canonicalizeHeader($header, string $headerCanon): string
    {
