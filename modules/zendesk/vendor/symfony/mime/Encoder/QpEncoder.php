...
class QpEncoder implements EncoderInterface
{
     ...
     * $firstLineOffset.
     */
    public function encodeString($string, ?string $charset = 'utf-8', int $firstLineOffset = 0, int $maxLineLength = 0): string
    {
     ...
     */
    private function encodeByteSequence($bytes, int &$size): string
    {
        $ret = '';
        $size = 0;
        foreach ($bytes as $b) {
