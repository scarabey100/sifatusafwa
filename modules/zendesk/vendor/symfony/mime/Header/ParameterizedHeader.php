...
final class ParameterizedHeader extends UnstructuredHeader
{
    ...
    public function __construct($name, string $value, array $parameters = [])
    {
     ...
     */
    private function createParameter($name, string $value): string
    {
        $origValue = $value;
     ...
     */
    private function getEndOfParameterValue($value, bool $encoded = false, bool $firstLine = false): string
    {
