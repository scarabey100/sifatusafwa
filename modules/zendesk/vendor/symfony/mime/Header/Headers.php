...
final class Headers
{
     ...
     * @return $this
     */
    public function addTextHeader($name, string $value): self
    {
     ...
     * @return $this
     */
    public function addParameterizedHeader($name, string $value, array $params = []): self
    {
     ...
     * @internal
     */
    public function setHeaderBody($type, string $name, $body): void
    {
        if ($this->has($name)) {
    ...
    public function getHeaderParameter($name, string $parameter): ?string
    {
        if (!$this->has($name)) {
            return null;
        }
     ...
     * @internal
     */
    public function setHeaderParameter($name, string $parameter, ?string $value): void
    {
        if (!$this->has($name)) {
