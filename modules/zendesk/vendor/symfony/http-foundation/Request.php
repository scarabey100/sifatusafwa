...
class Request
{
     ...
     */
    public function __construct($query = [], array $request = [], array $attributes = [], array $cookies = [], array $files = [], array $server = [], $content = null)
    {
     ...
     * @param string|resource|null $content    The raw body data
     */
    public function initialize($query = [], array $request = [], array $attributes = [], array $cookies = [], array $files = [], array $server = [], $content = null)
    {
     ...
     * @return static
     */
    public function duplicate($query = null, array $request = null, array $attributes = null, array $cookies = null, array $files = null, array $server = null)
    {
        $dup = clone $this;
        if (null !== $query) {
     ...
     */
    public static function setTrustedProxies($proxies, int $trustedHeaderSet)
    {
     ...
     */
    private function getUrlencodedPrefix($string, string $prefix): ?string
    {
    ...
    private static function createRequestFromFactory($query = [], array $request = [], array $attributes = [], array $cookies = [], array $files = [], array $server = [], $content = null): self
    {
    ...
    private function getTrustedValues($type, string $ip = null): array
    {
        $clientValues = [];
        $forwardedValues = [];
    ...
    private function normalizeAndFilterClientIps($clientIps, string $ip): array
    {
        if (!$clientIps) {
            return [];
        }
