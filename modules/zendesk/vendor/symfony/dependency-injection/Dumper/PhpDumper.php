...
EOF;
        ...
        if ($this->asFiles) {
            ...
            $code = str_replace('__construct()', '__construct($buildParameters = [], $containerDir = __DIR__)', $code);
...
EOF;
    ...
    private function getDefinitionsFromArguments($arguments, \SplObjectStorage $definitions = null, array &$calls = [], $byConstructor = null)
    {
        if (null === $definitions) {
