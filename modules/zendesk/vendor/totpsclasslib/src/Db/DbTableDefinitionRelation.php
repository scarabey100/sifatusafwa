...
class DbTableDefinitionRelation
{
    ...
    /**
     * @var zendeskObjectModelDefinition
     */
    protected $def;

    /**
     * Register zendeskObjectModelDefinition and the internal ID
     * @param zendeskObjectModelDefinition $def
     * @param string                $id
     */
    ...
    /**
     * Get key value from zendeskObjectModel::$definition['associations'][$this->id]
     * @param string $key
     * @return array|null
     */
