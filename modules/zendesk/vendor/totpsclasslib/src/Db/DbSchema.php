...
{
    /**
     * @var ZendeskClasslib\Db\ObjectModelDefinition
     */
    protected $def;
    ...
    /**
     * Register ZendeskClasslib\Db\ObjectModelDefinition and table (internal) ID
     * @param ZendeskClasslib\Db\ObjectModelDefinition $def
     * @param string                $id
     */
     ...
     * @param ZendeskClasslib\Db\DbTable $table
     * @return ZendeskClasslib\Db\DbTable
     */
