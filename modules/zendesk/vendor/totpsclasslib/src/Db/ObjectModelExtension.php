...
namespace ZendeskClasslib\Db;

use ZendeskClasslib\Db\ObjectModelDefinition;
use ZendeskClasslib\Db\DbTableDefinitionModel;
use ZendeskClasslib\Db\DbTableDefinitionRelation;
use ZendeskClasslib\Db\DbSchema;
use ZendeskClasslib\Db\DbTable;
...
class ObjectModelExtension
{
    ...
    /**
     * @return ZendeskClasslib\Db\ObjectModelDefinition (as an array collection object)
     */
    ...
    /**
     * @param ZendeskClasslib\Db\DbSchema $schema
     * @return bool
     */
