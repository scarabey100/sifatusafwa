...
namespace ZendeskClasslib\Extensions\ProcessMonitor;

use ZendeskClasslib\Extensions\ProcessMonitor\Classes\ProcessMonitorObjectModel;
...
{
    /**
     * @var ZendeskProcessMonitorObjectModel $process
     */
    protected $process;
