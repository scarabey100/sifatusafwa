...
namespace ZendeskClasslib\Extensions\ProcessLogger\Controllers\Admin;
...
class AdminProcessLoggerController extends \ModuleAdminController
{
    ...
    public $className = 'ZendeskClasslib\Extensions\ProcessLogger\Classes\ProcessLoggerObjectModel';

    /** @var string Associated table name */
    public $table = 'zendesk_processlogger';

    /** @var string|false Object identifier inside the associated table */
    public $identifier = 'id_zendesk_processlogger';

    /** @var string Default ORDER BY clause when is not defined */
    protected $_defaultOrderBy = 'id_zendesk_processlogger';
