...
use ZendeskClasslib\Extensions\ProcessMonitor\ProcessMonitorHandler;
use Configuration;
use Db;
use Hook;
use Tools;
...
class ProcessLoggerHandler
{
    ...
    public static function saveLogsInDb()
    {
        ...
        if (false === empty(self::$logs) && self::getSkippingHooksResult()) {
            ...
            Hook::exec(
                'actionZendeskProcessLoggerSave',
                [
                    'logs' => &self::$logs,
                ],
                null,
    ...
    {
        return false === (bool)Configuration::get('ZENDESK_EXTLOGS_ERASING_DISABLED');
    }
    ...
    {
        $numberOfDays = Configuration::get('ZENDESK_EXTLOGS_ERASING_DAYSMAX');
     ...
     * 'actionSkipZendeskProcessLoggerSave' returns false (weak comparison)
     *
     * @return bool
     *
     * @throws \PrestaShopException
    ...
    protected static function getSkippingHooksResult()
    {
        ...
        if (Hook::getIdByName('actionSkipZendeskProcessLoggerSave')) {
            $hookModuleProcessLoggerReturnArray = Hook::exec(
                'actionSkipZendeskProcessLoggerSave',
                [
                    'logs' => self::$logs,
                ],
                null,
