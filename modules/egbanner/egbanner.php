...
class EgBanner extends Module {
    ...
    public function __construct()
    {
        ...
        $this->displayName = $this->trans('Multiple banners 1', array(), $this->domain);
    ...
    */
    ...
    public function getTabs()
    {
        return [
            [
                'className' => 'AdminEgBannerGeneral',
                'parent' => 'CONFIGURE',
                'name' => $this->l('HP banners 1'),
                'module' => $this->name,
                'active' => true,
                'icon' => 'extension',
            ],
            [
                'className' => 'AdminEgConfBanner',
                'parent' => 'AdminEgBannerGeneral',
