...
/**
 * @property EgBannerTwoClass $object
 */
class AdminEgBannerTwoController extends ModuleAdminController
{
    protected $position_identifier = 'id_eg_banner';
    public function __construct()
    {
        $this->bootstrap = true;
        $this->table = 'eg_banner_two';
        $this->className = 'EgBannerTwoClass';
    ...
    public function postProcess()
    {
        ...
        if (Tools::isSubmit('forcedeleteImage') || Tools::getValue('deleteImage')) {
            ...
            EgBannerTwoClass::updateEgBannerImag($champ, $imgValue);
        ...
        $this->fields_form = array(
            ...
            'input' => array(
                ...
                array(
                    ...
                    'lang' => true,
                    'required' => true,
                    'desc' => $this->l('Veuillez entrer un lien pour la bannière.'),
                ),
                array(
                    'type' => 'text',
                    ...
                    'lang' => true,
                    'required' => true,
                    'desc' => $this->l('Veuillez saisir un texte personnalisé pour le bouton.'),
                ),
                /*
                array(
                    'type' => 'text',
                    ...
                    'lang' => true,
                    'required' => true,
                    'desc' => $this->l('Veuillez entrer un deuxième lien pour la bannière.'),
                ),
                array(
                    'type' => 'text',
                    'label' => $this->l('Texte du bouton 2'),
                    'name' => 'link_text_two',
                    'lang' => true,
                    'required' => true,
                    'desc' => $this->l('Veuillez saisir un texte personnalisé pour le bouton.'),
    ...
    public function ajaxProcessUpdatePositions()
    {
        ...
        foreach ($positions as $position => $value){
            ...
            if (isset($pos[2]) && (int)$pos[2] === $idEgBanner){
                if ($banner = new EgBannerTwoClass((int)$pos[2])){
