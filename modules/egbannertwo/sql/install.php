...
$sql[] = 'CREATE TABLE IF NOT EXISTS `'._DB_PREFIX_.'eg_banner_two` (
...
$sql[] = 'CREATE TABLE IF NOT EXISTS `'._DB_PREFIX_.'eg_banner_two_lang` (
...
$sql[] = 'CREATE TABLE IF NOT EXISTS `'._DB_PREFIX_.'eg_banner_two_shop` (
	`id_eg_banner` int(10) unsigned NOT NULL, 
