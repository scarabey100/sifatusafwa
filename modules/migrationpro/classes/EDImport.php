...
*
* @author    MigrationPro
* @copyright Copyright (c) 2012-2022 MigrationPro
        ...
        foreach ($carriers['carrier'] as $carrier) {
            ...
            if ($carrierObj = $this->createObjectModel('Carrier', $carrier['id_carrier'])) {
                ...
                if (!$res) {
                    ...
                    // Range_price
                    if(isset($carriers['range_price'][$carrier['id_carrier']])){
...
//                        // Range_weight
                    if(isset($carriers['range_weight'][$carrier['id_carrier']])){
...
//                        // Delivery
                    if(isset($carriers['carrier_delivery'][$carrier['id_carrier']])){
                    ...
                    $sql_values = array();
                    if(isset($carriers['carrier_tax_rules_group_shop'][$carrier['id_carrier']])){
                    ...
                    // Import Carrier Zone
                    $sql_values = array();
                    if(isset($carriers['carrier_zone'][$carrier['id_carrier']])){
    ...
    public function products($products)
    {
        ...
        // $for_loadimage_url = str_replace('1597452','source/1597452-image',$this->url);
        // $for_loadimage_url = str_replace('data73','data7',$for_loadimage_url);
        // var_dump("<pre>");
        // var_dump($products['image_ids']);
        // die;
        // var_dump($this->image_path);
        // die;
        // $this->loadImagesToLocal($products['image_ids'], 'id_image', 'products', $for_loadimage_url, $this->image_path);
        ...
        foreach ($products['supplier'] as $supplier) {
            ...
            if ($supplierObj = $this->createObjectModel('Supplier', $supplier['id_supplier'])) {
                ...
                // Add to _shop relations
					$id_shop_list = isset($supplier['id_shop_list']) ? $this->getChangedIdShop(explode(',', $supplier['id_shop_list']), '') : [];
                    ...
                    foreach ($products['image'][$product['id_product']] as $image) {
                        if ($imageObject = $this->createObjectModel('Image', $image['id_image'])) {
                            ...
                            if (!$res) {
                                ...
                                // die;
                                // $url = str_replace('1597452','source/1597452-image',$url);
                                // $url = str_replace('data73','data7',$url);
...
//                      import customer_groups
                    $sql_values = array();
                    if(isset($customers['customer_group'][$customer['id_customer']])){
        ...
        foreach ($cartRules['cartRule'] as $cartRule) {
            ...
            if ($cartRuleObj = $this->createObjectModel('CartRule', $cartRuleid)) {
                ...
                if (!$res) {
                    ...
                    $sql_values = array();
                    if(isset($cartRules['cart_rule_carriers'][$cartRuleid])){
                    ...
                    $sql_values = array();
                    if(isset($cartRules['cart_rule_countries'][$cartRuleid])){
                    ...
                    $sql_values = array();
                    if(isset($cartRules['cart_rule_groups'][$cartRuleid])){
                    ...
                    if(isset($cartRules['cart_rule_product_rule_groups'][$cartRuleid])){
                    ...
                    $sql_values = array();
                    if(isset($cartRules['cart_rule_shops'][$cartRuleid])){
...
//                }
                ...
                if (!$res) {
                    ...
                    if (version_compare(MigrationPro::mpConfigure('migrationpro_version', 'get'), '1.5', '<')) {
                        ...
                        if(isset($orders['order_payment'][$order['reference']])){
                    ...
                    if (version_compare(MigrationPro::mpConfigure('migrationpro_version', 'get'), '1.5', '<')) {
                        ...
                        if(isset($orders['order_invoice'][$order['id_order']])){
                        foreach ($orders['order_invoice'][$order['id_order']] as $orderInvoice) {
                            if ($orderInvoiceModel = $this->createObjectModel('OrderInvoice', $orderInvoice['id_order_invoice'])) {
                                ...
                                //import Invoice_Tax
                                $sql_values = array();
                                if(isset($orders['invoice_tax'][$orderInvoice['id_order_invoice']])){
                                ...
                                //import Invoice_Payment
                                $sql_values = array();
                                if(isset($orders['invoice_payment'][$order['id_order']])){
                        ...
                        if ($orderDetailModel = $this->createObjectModel('OrderDetail', $orderDetail['id_order_detail'])) {
                            ...
                            if (!$res) {
                                ...
                                if (version_compare(MigrationPro::mpConfigure('migrationpro_version', 'get'), '1.5', '<')) {
                                    ...
                                    $sql_values = array();
                                    if(isset($orders['order_detail_tax'][$orderDetail['id_order_detail']])){
                        ...
                        foreach ($cmses['cms_role'][$cms['id_cms']] as $cmsRole) {
                            if ($cmsRole['id_cms'] == $cms['id_cms']) {
                                if ($cmsRoleModel = $this->createObjectModel('CMSRole', $cmsRole['id_cms_role'])) {
                                    if(isset($cmses['cms_role_lang'][$cmsRole['id_cms_role']])){
    ...
    public function metas($metas)
    {
        ...
        foreach ($metas['meta'] as $meta) {
            ...
            if ($metaObj = $this->createObjectModel('Meta', $meta['id_meta'])) {
                ...
                if(isset($metas['meta_lang'][$meta['id_meta']])){
