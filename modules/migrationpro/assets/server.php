...
define('MP_TOKEN', "7a01442dfb7137379a59e7d8654bace5");
...
class MPServer {
    ...
    function run() {
        ...
        if (!$this->_checkToken()) {
            $this->response->error('The bridge connector module generated for sifatusafwa.egiodigital.com! Please, download again bridge connector module and install to the Source shop (old shop) and try connection again.', null);
            return;  
        }
