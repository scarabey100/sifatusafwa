...
function upgrade_module_4_0_0($module)
{
    ...
    if (((int) Configuration::get('SENDINBLUE_CONFIGURATION_OK')) !== 1
        || ((int) Configuration::get('Sendin_Api_Key_Status')) !== 1
        || empty($apiKeyV2)) {
        return true;
    }
    ...
    $smtpDetails = json_decode(Configuration::get('Sendin_Smtp_Result'));
