...
<div class="row">
    ...
    <div class="col-lg-12 panel">
        ...
        <form id="" class="defaultForm form-horizontal AdminCustomers"
              action="{$formUrl|escape:'htmlall':'UTF-8'}"
                ...
                <div class="radio">
                    <label>
                        <input type="radio" name="sib_sms_campaign_toggle"
                               value="0" {(!($Api_Sms_Campaign_Status|escape:'htmlall':'UTF-8')) ? 'checked="checked"' : ''}>
                        {l s='Disable' mod='sendinblue'}
                    </label>
                    <label>
                        <input type="radio" name="sib_sms_campaign_toggle"
                               value="1" {($Api_Sms_Campaign_Status|escape:'htmlall':'UTF-8') ? 'checked="checked"' : ''}>
            ...
            <div id="sib_sms_campaign" style=" {(!($Api_Sms_Campaign_Status|escape:'htmlall':'UTF-8')) ? 'display: none;' : ''}">
                        ...
                        <div class="radio">
                            <label>
                                <input name="Sendin_Sms_Choice" id="r1_Sendin_Sms_Choice" type="radio"
                                       value="0" {if $Sms_Campaign_Type|escape:'htmlall':'UTF-8' == 0} checked="checked" {/if}>
                            ...
                            <label>
                                <input name="Sendin_Sms_Choice" id="r3_Sendin_Sms_Choice"
                                       ...
                                       value="1" {if $Sms_Campaign_Type|escape:'htmlall':'UTF-8' == 1} checked="checked" {/if}>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-3">
                                    <select name="hour" id="sib_datetimepicker_hour"
                                        ...
                                        {for $counter=0 to 23}
                                            <option value={$counter|escape:'htmlall':'UTF-8'}>{$counter|escape:'htmlall':'UTF-8'}</option>
                                        {/for}
                                    </select>
                                </div>
                                <div class="col-lg-3">
