...
<div class="row">
  ...
  <div class="col-lg-12 panel">
    ...
    <div class="" id="">
      <div class="radio">
        <label>
          <input type="radio" name="sib_sms_shipment_confirmation_toggle" value="0" {(!($Api_Sms_shipment_Status|escape:'htmlall':'UTF-8')) ? 'checked="checked"' : ''}>
          {l s='Disable' mod='sendinblue'}
        </label>
        <label>
          <input type="radio" name="sib_sms_shipment_confirmation_toggle" value="1" {($Api_Sms_shipment_Status|escape:'htmlall':'UTF-8') ? 'checked="checked"' : ''}>
          {l s='Enable' mod='sendinblue'}
        </label>
      </div>
    </div>
    {*                         activate sms count notification  end *}
    <form  id="sib_sms_shipment_confirmation" class="defaultForm form-horizontal AdminCustomers" style="{(!($Api_Sms_shipment_Status|escape:'htmlall':'UTF-8')) ? 'display: none;' : ''}" action="index.php?controller=AdminCustomers&amp;back=%2Fadminlogin%2Findex.php%3Fcontroller%3DAdminCustomers%26id_customer%3D1%26viewcustomer%26token%3D00be965ec4afbc9ae7d04c3e119a2ecc&amp;token=00be965ec4afbc9ae7d04c3e119a2ecc" method="post" enctype="multipart/form-data" novalidate="" _lpchecked="1">
      <div class="" id="fieldset_0">
        <div class="form-wrapper">
          ...
          <div class="form-group">
            ...
            <div class="col-lg-4">
                <input type="text" name="sender_shipment" id="sender_shipment" class="input-text" autocomplete="off" value="{$Sender_Shipment|escape:'htmlall':'UTF-8'}" maxlength="11">
          ...
          <div class="form-group">
            ...
            <div class="col-lg-4">
              <textarea name="sender_shipment_message" id="sender_shipment_message" cols="45" rows="5" class="textarea_bx" style="resize: both">{$Sender_Shipment_Message|escape:'htmlall':'UTF-8'}</textarea>
              <div class="clear"></div>
          ...
          <div class="form-group">
            ...
            <button type="button" name="sender_shipment_submit" id="sender_shipment_submit" class="btn btn-outline-secondary btn-submit hidden-xs uppercase duplicate testSmsShipped" successmsg="{l s='Test SMS message has been sent successfully' mod='sendinblue'}"  failmsg="{l s='Test SMS message has not been sent successfully' mod='sendinblue'}"
            ...
            <div class="col-lg-4">
              ...
              <span><em>{l s='Sending a test SMS will be deducted from your SMS credits.' mod='sendinblue'}</em></span>
            </div>
    ...
    <div>
      <button type="submit" value="1" id="sender_shipment_save" name="sender_shipment_save" class="btn btn-default pull-right sender_shipment_save" senderfield="{l s='Please fill the sender field' mod='sendinblue'}"  messagefield="{l s='Please fill the message field' mod='sendinblue'}" successmsg="{l s='Settings updated' mod='sendinblue'}"  failmsg="{l s='Update failed' mod='sendinblue'}">
