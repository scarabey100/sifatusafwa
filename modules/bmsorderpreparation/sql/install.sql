CREATE TABLE IF NOT EXISTS `ps_bms_orderpreparation_inprogress` (
...
CREATE TABLE IF NOT EXISTS `ps_bms_orderpreparation_mime_type` (
...
INSERT INTO `ps_bms_orderpreparation_mime_type` (`id_bms_orderpreparation_mime_type`, `name`, `class`) VALUES
(1, 'CSV, XML', 'CsvXml');

CREATE TABLE IF NOT EXISTS `ps_bms_orderpreparation_shipping_template` (
...
CREATE TABLE IF NOT EXISTS `ps_bms_orderpreparation_shipping_template_type` (
...
INSERT INTO `ps_bms_orderpreparation_shipping_template_type` (`id_bms_orderpreparation_shipping_template_type`, `name`) VALUES
