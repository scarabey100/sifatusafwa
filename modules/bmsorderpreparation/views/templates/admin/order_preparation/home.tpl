 ...
 <div class="panel">
	<div class="form-wrapper">
  		<ul class="nav nav-tabs">
    		...
    		<li  class=""><a href="#inProgress" data-toggle="tab" data-noRefresh='false' data-href="{Context::getContext()->link->getAdminLink('AdminOrderTab')|escape:'htmlall':'UTF-8'}&filter=inProgress">{l s='In progress' mod='bmsorderpreparation'}</a></li>
  		</ul>
		<div class="tab-content panel">
  			...
  			<div id="inProgress" data-tab-id="inProgress active" class="tab-pane"><iframe id="inProgressFrame" frameborder= '0' scrolling= 'no' width= '100%' onload="resizeIframe(this)"  src=""></iframe> </div>  
		</div>
	</div>
</div>