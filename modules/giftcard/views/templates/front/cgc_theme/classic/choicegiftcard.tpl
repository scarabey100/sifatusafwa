...
<div id="choicegiftcard" data-link-controller="{$linkcgc|escape:'htmlall':'UTF-8'}">
	...
	<div id="templates_block">
		<ul  class="gctabs clearfix">
			<li><a id="tab_template_all"  href="javascript:;" class="selected tab_template" data-tab="block_templates_all">{l s='All' mod='giftcard'}&nbsp;(<span class="ta-gc-number">{$gc_templates|@count|intval}</span>)</a></li>
