...
namespace PaypalAddons\Clue\StreamFilter;
 ...
 *
 * ```php
 * $filter = PaypalAddons\Clue\StreamFilter\append($stream, function ($chunk) {
 ...
 *
 * ```php
 * PaypalAddons\Clue\StreamFilter\append($stream, 'strtoupper');
 *
 ...
 *
 * ```php
 * PaypalAddons\Clue\StreamFilter\append($stream, function ($chunk = null) {
 *     if ($chunk === null) {
 ...
 *
 * ```php
 * PaypalAddons\Clue\StreamFilter\append($stream, function ($chunk) {
 ...
 *
 * ```php
 * $filter = PaypalAddons\Clue\StreamFilter\prepend($stream, function ($chunk) {
 *     // will be called each time you read or write a $chunk to/from the stream
 *     return $chunk;
 * });
 * ```
 ...
 *
 * ```php
 * $fun = PaypalAddons\Clue\StreamFilter\fun('string.rot13');
 *
 ...
 *
 * ```php
 * PaypalAddons\Clue\StreamFilter\fun('unknown'); // throws RuntimeException
 * ```
 *
 ...
 *
 * ```php
 * $fun = PaypalAddons\Clue\StreamFilter\fun('string.strip_tags', '<a><b>');
 *
 * $ret = $fun('<b>h<br>i</b>');
 * assert('<b>hi</b>' === $ret);
 * ```
 ...
 *
 * ```php
 * $fun = PaypalAddons\Clue\StreamFilter\fun('zlib.deflate');
 *
 ...
 *
 * ```php
 * $filter = PaypalAddons\Clue\StreamFilter\append($stream, function () {
 *     // …
 * });
 * PaypalAddons\Clue\StreamFilter\remove($filter);
 * ```
 *
