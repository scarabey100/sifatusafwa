...
namespace PaypalAddons\Prestashop\ModuleLibGuzzleAdapter\Guzzle7;

use GuzzleHttp\Exception as GuzzleExceptions;
use GuzzleHttp\Promise\PromiseInterface;
use PaypalAddons\Http\Client\Exception as HttplugException;
use PaypalAddons\Http\Promise\Promise as HttpPromise;
use PaypalAddons\Prestashop\ModuleLibGuzzleAdapter\Guzzle7\Exception\UnexpectedValueException;
use PaypalAddons\Psr\Http\Message\RequestInterface;
use PaypalAddons\Psr\Http\Message\ResponseInterface;
