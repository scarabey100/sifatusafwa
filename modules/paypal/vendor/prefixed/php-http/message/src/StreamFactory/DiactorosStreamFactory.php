...
namespace PaypalAddons\Http\Message\StreamFactory;

use PaypalAddons\Http\Message\StreamFactory;
...
if (!interface_exists(StreamFactory::class)) {
    throw new \LogicException('You cannot use "PaypalAddons\Http\Message\MessageFactory\DiactorosStreamFactory" as the "php-http/message-factory" package is not installed. Try running "composer require php-http/message-factory". Note that this package is deprecated, use "psr/http-factory" instead');
}
