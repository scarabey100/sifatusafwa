...
<p class="lgmessage lgdebug" style="background-color:#2eacce;">
    ...
    <strong>{l s='Name' mod='lgfreeshippingzones'}:</strong> {$debugInfo['Shop']['name']|escape:'html':'UTF-8'}<br><br>
    ...
    {if (isset($debugInfo['Addresses']))}
        {foreach $debugInfo['Addresses'] as $address}
            ...
            <strong style="padding-left: 20px;">{l s='Name' mod='lgfreeshippingzones'}:</strong> {$address['address']|escape:'html':'UTF-8'}<br>
            <strong style="padding-left: 20px;">{l s='Zone ID' mod='lgfreeshippingzones'}:</strong> {$address['ZoneID']|intval}<br>
            <strong style="padding-left: 20px;">{l s='Zone Name' mod='lgfreeshippingzones'}:</strong> {$address['ZoneName']|escape:'html':'UTF-8'}<br><br>
            ...
            {foreach $address['Packages'] as $package}
                ...
                <strong style="padding-left: 40px;">{l s='Products Cost' mod='lgfreeshippingzones'}:</strong> {displayPrice price=$package['TotalCost']}<br>
                {*<strong style="padding-left: 40px;">{l s='Shipping Cost' mod='lgfreeshippingzones'}:</strong> {if $package['TotalShipping'] == 0}{l s='Free' mod='lgfreeshippingzones'}{else}{displayPrice price=$package['TotalShipping']}{/if}<br>*}
                <strong style="padding-left: 40px;">{l s='Package Weight' mod='lgfreeshippingzones'}:</strong> {$package['TotalWeight']|escape:'html':'UTF-8'} {$weight_unit|escape:'html':'UTF-8'}<br><br>
                <strong style="padding-left: 60px;">{l s='Carriers' mod='lgfreeshippingzones'}:</strong><br><span style="padding-left: 60px;">----</span><br>
                <strong style="padding-left: 60px;">{l s='Number of carriers' mod='lgfreeshippingzones'}:</strong> {$package['NumberOfCarriers']|escape:'html':'UTF-8'}<br>
                ...
                {else}
                    {foreach $package['Carriers'] as $carrier}
                        ...
                        <strong style="padding-left: 60px;">{l s='Name' mod='lgfreeshippingzones'}:</strong> {$carrier['name']|escape:'html':'UTF-8'}<br>
                        ...
                        {else}
                            {l s='From' mod='lgfreeshippingzones'} {if $carrier['PriceMin'] > 0}{$carrier['PriceMin']|escape:'html':'UTF-8'}{else}&infin;{/if}
                            {l s='to' mod='lgfreeshippingzones'} {if $carrier['PriceMax'] > 0}{$carrier['PriceMax']|escape:'html':'UTF-8'}{else}&infin;{/if}
                        {/if}
                        <br>
                        ...
                        {if ($carrier['WeightMin'] == 0 and $carrier['WeightMin'] == 0)}
                            {l s='All' mod='lgfreeshippingzones'}
                        {else}
                            {l s='From' mod='lgfreeshippingzones'} {if $carrier['WeightMin'] > 0}{$carrier['WeightMin']|escape:'html':'UTF-8'}{else}&infin;{/if}
                            {l s='to' mod='lgfreeshippingzones'} {if $carrier['WeightMax'] > 0}{$carrier['WeightMax']|escape:'html':'UTF-8'}{else}&infin;{/if}
                        {/if}
                        {if $lgfs_usetax}
                            {l s='TAX included' mod='lgfreeshippingzones'}{else}{l s='TAX excluded' mod='lgfreeshippingzones'}
                        {/if}
                        <br>
                        <strong style="padding-left: 60px;">{l s='Reference' mod='lgfreeshippingzones'}:</strong> {$carrier['reference']|escape:'html':'UTF-8'}<br>
                        ...
                        <strong style="padding-left: 60px;">{l s='Shipping Cost' mod='lgfreeshippingzones'}:</strong> {if $carrier['shippingCost'] == 0 || $debugInfo['free_shipping_voucher_code']}{l s='Free' mod='lgfreeshippingzones'}{else}{displayPrice price=$carrier['shippingCost']|escape:'html':'UTF-8'}{/if}<br><br>
                            ...
                            {if $carrier['shippingCost'] > 0 && !$debugInfo['free_shipping_voucher']}
                                {if $carrier['PriceMin'] == 0 and $carrier['PriceMax'] == 0 and $carrier['WeightMin'] == 0 and $carrier['WeightMax'] == 0}
                                    <span style="background-color:#FE9126; padding:5px;">
                                        ...
                                        {l s='Free shipping is not configured in the module for the zone' mod='lgfreeshippingzones'} {$address['ZoneName']|escape:'html':'UTF-8'}
                                        {l s='and carrier' mod='lgfreeshippingzones'} {$carrier['name']|escape:'html':'UTF-8'}
                                ...
                                {if $carrier['PriceMin'] > 0 and $package['TotalCost'] < $carrier['PriceMin']}
                                    <span style="background-color:#FE9126; padding:5px;">
                                        ...
                                        {displayPrice price=$package['TotalCost']} < {displayPrice price=$carrier['PriceMin']}
                                        <i class="icon-exclamation-triangle"></i>
                                    </span>
                                    <br>
                                {/if}
                                {if $carrier['WeightMin'] > 0 and $package['TotalWeight'] < $carrier['WeightMin']}
                                    <span style="background-color:#FE9126; padding:5px;">
                                        ...
                                        {$package['TotalWeight']|escape:'html':'UTF-8'} {$weight_unit|escape:'html':'UTF-8'}
                                        < {$carrier['WeightMin']|escape:'html':'UTF-8'} {$weight_unit|escape:'html':'UTF-8'}
                                        <i class="icon-exclamation-triangle"></i>
                                    </span>
                                    <br>
                                {/if}
                                {if $carrier['PriceMax'] > 0 and $package['TotalCost'] > $carrier['PriceMax']}
                                    <span style="background-color:#FE9126; padding:5px;">
                                        ...
                                        {displayPrice price=$package['TotalCost']} > {displayPrice price=$carrier['PriceMax']}
                                        <i class="icon-exclamation-triangle"></i>
                                    </span>
                                    <br>
                                {/if}
                                {if $carrier['WeightMax'] > 0 and $package['TotalWeight'] > $carrier['WeightMax']}
                                    <span style="background-color:#FE9126; padding:5px;">
                                        ...
                                        {$package['TotalWeight']|escape:'html':'UTF-8'} {$weight_unit|escape:'html':'UTF-8'}
                                        > {$carrier['WeightMax']|escape:'html':'UTF-8'} {$weight_unit|escape:'html':'UTF-8'}
                                        <i class="icon-exclamation-triangle"></i>
                                    </span>
                                    <br>
                                {/if}
                            ...
                            {if $carrier['shippingCost'] === 0 || $debugInfo['free_shipping_voucher']}
                                ...
                                {if $carrier['isFree'] > 0}
                                    <span style="background-color:#ff0000; padding:5px;">
                                        <i class="icon-exclamation-triangle"></i>
                                        {l s='Free shipping is permanently enabled for the carrier' mod='lgfreeshippingzones'} {$carrier['name']|escape:'html':'UTF-8'}
                                ...
                                {if $carrier['carrierCheck'] > 0}
                                    <span style="background-color:#ff0000; padding:5px;">
                                        <i class="icon-exclamation-triangle"></i>
                                        {l s='The carrier' mod='lgfreeshippingzones'} {$carrier['name']|escape:'html':'UTF-8'}
                                        {l s='is not enabled for the zone' mod='lgfreeshippingzones'} {$address['ZoneName']|escape:'html':'UTF-8'}
                                        {l s='(please check your carrier configuration)' mod='lgfreeshippingzones'}
                                        <i class="icon-exclamation-triangle"></i>
                                    </span>
                                    <br>
                                ...
                                {if !$debugInfo['free_shipping_voucher'] and !$carrier['isFree'] and !$carrier['carrierCheck'] and !$debugInfo['GeneralConfig']}
                                    {if $carrier['PriceMin'] > 0 and $package['TotalCost'] > $carrier['PriceMin']}
                                        <span style="background-color:#55C65E; padding:5px;">
                                            ...
                                            {displayPrice price=$package['TotalCost']} > {displayPrice price=$carrier['PriceMin']}
                                            {displayPrice price=$package['TotalCost']|escape:'html':'UTF-8'} > {displayPrice price=$carrier['PriceMin']|escape:'html':'UTF-8'}
                                        </span><br>
                                    {/if}
                                    {if $carrier['PriceMax'] > 0 and $package['TotalCost'] < $carrier['PriceMax']}
                                        <span style="background-color:#55C65E; padding:5px;">
                                            ...
                                            {displayPrice price=$package['TotalCost']} < {displayPrice price=$carrier['PriceMax']}
                                            {displayPrice price=$package['TotalCost']|escape:'html':'UTF-8'} < {displayPrice price=$carrier['PriceMax']|escape:'html':'UTF-8'}
                                        </span><br>
                                    {/if}
                                    {if $carrier['WeightMin'] > 0 and $package['TotalWeight'] > $carrier['WeightMin']}
                                        <span style="background-color:#55C65E; padding:5px;">
    ...
    {if !$debugInfo['undeliverable']}
        ...
        <strong>{l s='Total Products cost' mod='lgfreeshippingzones'}:</strong> {displayPrice price=$debugInfo['Totals']['ProductsCost']}<br>
        <strong>{l s='Total Shipping cost' mod='lgfreeshippingzones'}:</strong> {displayPrice price=$debugInfo['Totals']['ShippingCost']}<br>
        <strong>{l s='Total weight' mod='lgfreeshippingzones'}:</strong> {$debugInfo['Totals']['Weight']|escape:'html':'UTF-8'} {$weight_unit|escape:'html':'UTF-8'}<br>
        <strong>{l s='Free Shipping Vouchers' mod='lgfreeshippingzones'}:</strong>
        {if $debugInfo['free_shipping_voucher']}
            {$debugInfo['free_shipping_voucher_code']|escape:'html':'UTF-8'}: -{displayPrice price=$debugInfo['Totals']['ShippingCost']}<br>
        {else}
            {l s='None' mod='lgfreeshippingzones'}<br>
        {/if}
        <strong>{l s='Final shipping costs' mod='lgfreeshippingzones'}: {if $debugInfo['free_shipping_voucher']}{displayPrice price=0}{else}{displayPrice price=$debugInfo['Totals']['ShippingCost']}{/if}</strong>
    {/if}
</p>
<p class="lgmessage lgdebug" style="background-color:#2eacce;">
        ...
        {if (isset($debugInfo['Addresses']))}
            {foreach $debugInfo['Addresses'] as $address}
                <span style="padding-left: 20px;">
                        {*{l s='For this address:' mod='lgfreeshippingzones'} <span style="font-style: italic">{$address['address']|escape:'html':'UTF-8'}</span>,*}
                        ...
                        {else}
                            {foreach $package['Carriers'] as $carrier}
                                ...
                                {if (!$debugInfo['free_shipping_voucher_code'] and !$carrier['isFree'] and $carrier['shippingCost'] > 0)}
                                    ...
                                    {displayPrice price=$carrier['shippingCost']}
                                {/if}
                            {/foreach}
                        {/if}
                    </span><br>
