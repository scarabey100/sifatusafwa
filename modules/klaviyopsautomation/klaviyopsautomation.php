...
class KlaviyoPsAutomation extends KlaviyoPsModule
{
    ...
    {
        return parent::install() && $this->installPsAccounts();
    }

    public function installPsAccounts()
    {
        /** @var EnvService $envService */
        $envService = $this->getService('klaviyops.util_services.env');
        ...
        try {
            ...
            $psAccountsInstaller = $this->getService('klaviyops.ps_accounts.installer');
            ...
            $this->_errors[] = $this->l('You must install PrestaShop Accounts');
            return false;
        } catch (ModuleVersionException $e) {
            $this->_errors[] = $this->l('You must update PrestaShop Accounts');
            return false;
        } catch (Exception $e) {
    ...
    private function isModuleCompatible($moduleName, $minVersion)
    {
        ...
        throw new ModuleNotInstalledException();
    }
