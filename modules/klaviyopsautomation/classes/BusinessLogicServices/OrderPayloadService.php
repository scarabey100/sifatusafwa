...
class OrderPayloadService extends PayloadServiceInterface
{
    ...
    public static function buildPayload(ObjectModelCore $order, $id_shop = null)
    {
        ...
        foreach ($orderProducts as $item) {
            ...
            // We need to remove "tax_calculator" key because it contains an object
            // With circular reference that causes json_encode to fail
            if (isset($hydratedProduct['tax_calculator'])) {
                unset($hydratedProduct['tax_calculator']);
            }

            $hydratedOrderProducts[] = $hydratedProduct;
        }
